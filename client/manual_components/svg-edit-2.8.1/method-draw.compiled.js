            ...
            b.prototype.parseSegment = function () {
                ...
                switch (s) {
                    ...
                    case SVGPathSeg.PATHSEG_CURVETO_CUBIC_REL:
                        l = {x1: this._parseNumber(), y1: this._parseNumber(), x2: this._parseNumber(), y2: this._parseNumber(), x: this._parseNumber(), y: this._parseNumber()};
                    ...
                    case SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_REL:
                        l = {x2: this._parseNumber(), y2: this._parseNumber(), x: this._parseNumber(), y: this._parseNumber()};
                    ...
                    case SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_ABS:
                        l = {x1: this._parseNumber(), y1: this._parseNumber(), x: this._parseNumber(), y: this._parseNumber()};
                    ...
                    case SVGPathSeg.PATHSEG_ARC_ABS:
                        l = {
                            x1: this._parseNumber(), y1: this._parseNumber(), arcAngle: this._parseNumber(), arcLarge: this._parseArcFlag(), arcSweep: this._parseArcFlag(),
                            x: this._parseNumber(), y: this._parseNumber()
                        };
...
(function (a) {
    ...
    a.svgIcons = function (b, l) {
            ...
            if (!H) {
                ...
                if (Z) {
                    ...
                    a.each(Z, function (Ia, Ka) {
                        a("#" + Ia);
                        var Ba = a(new Image).attr({"class": "svg_icon", src: pa + Ka, width: C, height: v, alt: "icon"});
                        ia(Ba, Ia)
                    })
        ...
        var p = "http://www.w3.org/2000/svg", w = "http://www.w3.org/1999/xlink", C = l.w ? l.w : 24, v = l.h ? l.h : 24, L, Q, J, H = false, U = false, R = 0, N = navigator.userAgent,
            ca = !!window.opera;
...
(function () {
    ...
    jQuery.fn.jGraduateDefaults = {paint: new $.jGraduate.Paint, window: {pickerTitle: "Drag markers to pick a paint"}, images: {clientPath: "images/"}, newstop: "inverse"};
        ...
        return this.each(function () {
            function s(ha, Y, ja, M, P) {
                ...
                $(Ca).mousedown(function (Ma) {
                    ...
                    Y = Za.substr(1) + nb;
                    $("#" + v + "_jGraduate_stopPicker").css({left: 100, bottom: 15}).jPicker({
            ...
            if (L) {
                ...
                $.extend(true, w, {paint: new $.jGraduate.Paint({copy: C.paint}), okCallback: $.isFunction(l[1]) && l[1] || null, cancelCallback: $.isFunction(l[2]) && l[2] || null});
                w.position();
                var H = null, U = $(window);
                ...
                var ka = $("#" + v + "_jGraduate_GradContainer")[0], Z = a("svg", {id: v + "_jgraduate_svg", width: ca, height: ca, xmlns: o.svg}, ka);
                W = W || w.paint.type;
                ...
                ta = a("rect", {id: v + "_jgraduate_rect", x: 0, y: 0, width: la, height: X, fill: "url(#" + v + "_jgraduate_grad)", "fill-opacity": pa / 100}, Z);
                var Ka = $("<div/>").attr({"class": "grad_coord jGraduate_lg_field", title: "Begin Stop"}).text(1).css({top: ma * ca, left: H * ca}).data("coord", "start").appendTo(ka),
                    Ba = Ka.clone().text(2).css({top: Ja * ca, left: na * ca}).attr("title", "End stop").data("coord", "end").appendTo(ka),
                    xa = $("<div/>").attr({"class": "grad_coord jGraduate_rg_field", title: "Center stop"}).text("C").css({top: Na * ca, left: Fa * ca}).data("coord", "center").appendTo(ka),
                    ra = xa.clone().text("F").css({top: Ia * ca, left: Sa * ca, display: "none"}).attr("title", "Focus point").data("coord", "focus").appendTo(ka);
                ...
                var wa, kb, vb = $("#" + v + "_jGraduate_StopSlider"), cb, Ta, Va,
                    Da = a("path", {d: "m9.75,-6l-19.5,19.5m0,-19.5l19.5,19.5", fill: "none", stroke: "#D00", "stroke-width": 5, display: "none"},
                ...
                a("image", {width: 16, height: 16}, ka).setAttributeNS(o.xlink, "xlink:href", C.images.clientPath + "map-opacity.png");
                ...
                N = {
                    radius: {handle: "#" + v + "_jGraduate_RadiusArrows", input: "#" + v + "_jGraduate_RadiusInput", val: (fa.getAttribute("r") || 0.5) * 100},
                    opacity: {handle: "#" + v + "_jGraduate_OpacArrows", input: "#" + v + "_jGraduate_OpacInput", val: w.paint.alpha || 100},
                    ellip: {handle: "#" + v + "_jGraduate_EllipArrows", input: "#" + v + "_jGraduate_EllipInput", val: N},
                    angle: {
                ...
                R.jPicker({window: {title: C.window.pickerTitle}, images: {clientPath: C.images.clientPath}, color: {active: H, alphaSupport: true}}, function (ha) {
...
(function () {
    ...
    if (svgedit.browser.supportsSvg()) {
        var o = navigator.userAgent, e = document.createElementNS("http://www.w3.org/2000/svg", "svg"), b = !!window.opera, l = o.indexOf("AppleWebKit") >= 0, s = o.indexOf("Gecko/") >= 0,
            c = o.indexOf("MSIE") >= 0, g = o.indexOf("Chrome/") >= 0, d = o.indexOf("Windows") >= 0, p = o.indexOf("Macintosh") >=
...
(function () {
    ...
    svgedit.select.Selector = function (b, l) {
        ...
        this.selectorRect = this.selectorGroup.appendChild(a.createSVGElement({
            element: "path",
            attr: {id: "selectedBox" + this.id, fill: "none", stroke: "#4F80FF", "stroke-width": "1", "shape-rendering": "crispEdges", style: "pointer-events:none"}
        }));
    ...
    svgedit.select.SelectorManager.prototype.initGroup = function () {
            ...
            l = a.createSVGElement({
                element: "rect", attr: {
                    id: "selectorGrip_resize_" +
                        b, width: 8, height: 8, fill: "#4F80FF", stroke: "rgba(0,0,0,0)", "stroke-width": 1, style: "cursor:" + b + "-resize", "pointer-events": "all"
                }
            });
            if (svgedit.browser.isTouch()) {
        ...
        if (!$("#canvasBackground").length) {
            ...
            var s = a.createSVGElement({element: "pattern", attr: {id: "checkerPattern", patternUnits: "userSpaceOnUse", x: 0, y: 0, width: 20, height: 20, viewBox: "0 0 10 10"}}),
                c = a.createSVGElement({element: "rect", attr: {x: 0, y: 0, width: 10, height: 10, fill: "#fff"}}),
                g = a.createSVGElement({element: "rect", attr: {x: 0, y: 0, width: 5, height: 5, fill: "#eee"}}), d = a.createSVGElement({
                    element: "rect",
                    attr: {x: 5, y: 5, width: 5, height: 5, fill: "#eee"}
                }), p = a.createSVGElement({
                    element: "rect",
                    attr: {width: "100%", height: "100%", x: 0, y: 0, "stroke-width": 1, stroke: "#000", fill: "url(#checkerPattern)", style: "pointer-events:none"}
                });
            b.appendChild(l);
            l.appendChild(s);
            s.appendChild(c);
    ...
    svgedit.select.SelectorManager.prototype.getRubberBandBox = function () {
        if (!this.rubberBandBox) this.rubberBandBox = this.selectorParentGroup.appendChild(a.createSVGElement({
            element: "rect",
            attr: {id: "selectorRubberBand", fill: "none", stroke: "#666", "stroke-width": 1, "stroke-dasharray": "3,2", display: "none", style: "pointer-events:none"}
        }));
...
(function () {
    ...
    var a = "a,circle,ellipse,foreignObject,g,image,line,path,polygon,polyline,rect,svg,text,tspan,use".split(","), o = {LET_DOCUMENT_DECIDE: 0, ALWAYS_RANDOMIZE: 1, NEVER_RANDOMIZE: 2},
...
(function () {
    ...
    var a = {pathNodeTooltip: "Drag node to move it. Double-click node to change segment type", pathCtrlPtTooltip: "Drag control point to adjust curve properties"}, o = {
        2: ["x", "y"],
        4: ["x", "y"],
        6: ["x", "y", "x1", "y1", "x2", "y2"],
        8: ["x", "y", "x1", "y1"],
    ...
    svgedit.path.getPointGrip = function (g, d) {
        ...
        if (d) {
            ...
            svgedit.utilities.assignAttributes(p, {x: w.x - (svgedit.browser.isTouch() ? 15 : 2.5), y: w.y - (svgedit.browser.isTouch() ? 15 : 2.5), display: "inline"})
        }
        return p
    };
    svgedit.path.getControlPoints = function (g) {
        ...
        for (var C = [svgedit.path.path.segs[p - 1].item, d], v = 1; v < 3; v++) {
            var L = p + "c" + v, Q = w["c" + v + "_line"] = svgedit.path.getCtrlLine(L), J = svgedit.path.getGripPt(g, {x: d["x" + v], y: d["y" + v]}),
    ...
    svgedit.path.getSegSelector = function (g, d) {
        ...
        if (!w) {
            ...
            svgedit.utilities.assignAttributes(w, {
                id: "segline_" + p, display: "none", fill: "none", stroke: "#0ff", "stroke-opacity": 1, "shape-rendering": "crispEdges",
                "stroke-width": 2, style: "pointer-events:none", d: "M0,0 0,0"
            });
            C.appendChild(w)
        }
        if (d) {
    ...
    svgedit.path.Segment.prototype.update = function (g) {
        if (this.ptgrip) {
            ...
            svgedit.utilities.assignAttributes(this.ptgrip, this.ptgrip.nodeName == "rect" ? {x: d.x - p, y: d.y - p} : {cx: d.x, cy: d.y});
...
$.SvgCanvas = function (a, o) {
    ...
    var J = Q.shape, H = Array(1), U = this.addSvgElementFromJson = function (f) {
            ...
            f.curStyles && svgedit.utilities.assignAttributes(h, {
                fill: J.fill, stroke: J.stroke, "stroke-width": J.stroke_width, "stroke-dasharray": J.stroke_dasharray, "stroke-opacity": J.stroke_opacity, "fill-opacity": J.fill_opacity,
                opacity: J.opacity / 2, style: "pointer-events:inherit"
            }, 100);
            svgedit.utilities.assignAttributes(h, f.attr, 100);
            svgedit.utilities.cleanupElement(h);
            return h
        }, R = c.getTransformList = svgedit.transformlist.getTransformList, N = svgedit.math.transformPoint, ca = c.matrixMultiply = svgedit.math.matrixMultiply,
        la = c.hasMatrixTransform = svgedit.math.hasMatrixTransform, X = c.transformListToTransform = svgedit.math.transformListToTransform, W = svgedit.math.snapToAngle,
    ...
    var pa = c.getRotationAngle = svgedit.utilities.getRotationAngle, oa = c.getElem = svgedit.utilities.getElem, ma = c.assignAttributes = svgedit.utilities.assignAttributes,
        na = this.cleanupElement = svgedit.utilities.cleanupElement, Ja = svgedit.sanitize.getNSMap(), Fa = c.sanitizeSvg = svgedit.sanitize.sanitizeSvg, Na = svgedit.history.MoveElementCommand,
    ...
    var wa = svgedit.utilities.snapToGrid, kb = {
        exportNoBlur: "Blurred elements will appear as un-blurred", exportNoforeignObject: "foreignObject elements will not appear",
        exportNoDashArray: "Strokes will appear filled", exportNoText: "Text may not appear as expected"
    ...
    this.addExtension = function (f, h) {
        if (f in eb) console.log('Cannot add extension "' + f + '", an extension by that name already exists"'); else {
            var m = $.isFunction(h) ? h($.extend(c.getPrivateMethods(), {svgroot: d, svgcontent: p, nonce: C().getNonce(), selectorManager: ra})) : h;
            eb[f] = m;
            M("extension_added", m)
        }
    };
    ...
    var Ca = this.recalculateAllSelectedDimensions = function () {
        ...
        if (f.tagName == "g" && !G || f.tagName == "a") {
            ...
            var q = {x: A.x + A.width / 2, y: A.y + A.height / 2}, u = N(A.x + A.width / 2, A.y + A.height / 2, X(h).matrix);
            B = d.createSVGMatrix();
            if (A = pa(f)) {
                k = A * Math.PI / 180;
    ...
    (function () {
        var f = null, h = null, m = null, B = null, A = null, G = {}, D = {minx: null, miny: null, maxx: null, maxy: null};
            ...
            if (!c.spaceKey) {
                ...
                switch (Ea) {
                    ...
                    case "fhpath":
                        ...
                        U({element: "polyline", curStyles: true, attr: {points: f, id: ja(), fill: "none", opacity: J.opacity / 2, "stroke-linecap": "round", style: "pointer-events:none"}});
                        D.minx = u;
                        D.maxx = u;
                        D.miny = E;
                        D.maxy = E;
                    ...
                    case "image":
                        Ga = true;
                        K = U({element: "image", attr: {x: n, y: k, width: 0, height: 0, id: ja(), opacity: J.opacity / 2, style: "pointer-events:inherit"}});
                        Z(K, Da);
                        Fb(K);
                        break;
                    case "square":
                    case "rect":
                        ...
                        h = n;
                        m = k;
                        U({element: "rect", curStyles: true, attr: {x: n, y: k, width: 0, height: 0, id: ja(), opacity: J.opacity / 2}});
                        break;
                    case "line":
                        Ga = true;
                        K = J.stroke_width == 0 ? 1 : J.stroke_width;
                    ...
                    case "ellipse":
                        Ga = true;
                        U({element: "ellipse", curStyles: true, attr: {cx: n, cy: k, rx: 0, ry: 0, id: ja(), opacity: J.opacity / 2}});
                        break;
                    case "text":
                        Ga = true;
                        U({
            ...
            if (!(z.originalEvent.touches && z.originalEvent.touches.length > 1)) if (Ga) if (!(z.button ===
                ...
                switch (Ea) {
                    ...
                    case "multiselect":
                        u *= v;
                        E *= v;
                        ma(sa, {x: Math.min(B, u), y: Math.min(A, E), width: Math.abs(u - B), height: Math.abs(E - A)}, 100);
                        q = [];
                        u = [];
                        K = ob();
                        E = H.length;
                    ...
                    case "zoom":
                        u *= v;
                        E *= v;
                        ma(sa, {x: Math.min(B * v, u), y: Math.min(A * v, E), width: Math.abs(u - B * v), height: Math.abs(E - A * v)}, 100);
                        break;
                    case "text":
                        ma(q, {x: x, y: y}, 1E3);
                        break;
                ...
                if (Ga) {
                    ...
                    switch (Ea) {
                        ...
                        case "zoom":
                            ...
                            M("zoomed", {x: Math.min(B, q), y: Math.min(A, u), width: Math.abs(q - B), height: Math.abs(u - A), factor: z.altKey ? 0.5 : 2});
                            return;
                        case "fhpath":
                        ...
                        case "fhellipse":
                            if (D.maxx - D.minx > 0 && D.maxy - D.miny > 0) {
                                E = U({
                                    element: "ellipse",
                                    curStyles: true,
                                    attr: {cx: (D.minx + D.maxx) / 2, cy: (D.miny + D.maxy) / 2, rx: (D.maxx - D.minx) / 2, ry: (D.maxy - D.miny) / 2, id: Y()}
                                });
                                M("changed", [E]);
                                I = true
                            }
                        ...
                        case "fhrect":
                            if (D.maxx -
                                ...
                                E = U({element: "rect", curStyles: true, attr: {x: D.minx, y: D.miny, width: D.maxx - D.minx, height: D.maxy - D.miny, id: Y()}});
                                M("changed", [E]);
                                I = true
                            }
                            break;
    ...
    var Fb = function (f) {
        ...
        function h(S, ea, ga) {
            if (S === ea) f(ea); else {
                ...
                ma(q, {d: "M" + ea.x + "," + ea.y + " L" + ga.x + "," + ga.y + " " + S.x + "," + S.y + " " + qa.x + "," + qa.y + "z", display: "inline"})
            }
        }
        ...
        return {
            mouseDown: function (D, z, F, k) {
                ...
                if (Ea === "path") {
                    ...
                    n = svgedit.path.getPointFromGrip({x: svgedit.path.path.dragging[0], y: svgedit.path.path.dragging[1]}, svgedit.path.path);
            ...
            mouseUp: function (D, z, F, k) {
                ...
                var D = H[0];
                if (D) if (pa(D) != 0) {
                    var z = new Ba("Reorient path"), F = {d: D.getAttribute("d"), transform: D.getAttribute("transform")};
                ...
                for (var F = D.pathSegList, k = F.numberOfItems, n = 0, q = 0, u = "", E = null, I = 0; I < k; ++I) {
                    var K = F.getItem(I), O = K.x || 0, V = K.y || 0, aa = K.x1 || 0, S = K.y1 || 0, ea = K.x2 || 0, ga = K.y2 || 0, T = K.pathSegType,
                        qa = Ma[T]["to" + (z ? "Lower" : "Upper") + "Case"](), va = function (za, Aa, Oa) {
                            Aa = Aa ? " " + Aa.join(" ") : "";
    ...
    this.rasterExport = function () {
        ya();
        var f = [], h = {feGaussianBlur: kb.exportNoBlur, foreignObject: kb.exportNoforeignObject, "[stroke-dasharray]": kb.exportNoDashArray}, m = $(p);
    ...
    var Db = this.pushGroupProperties = function (f, h) {
        var m = f.childNodes, B = m.length, A = f.getAttribute("transform"), G = R(f), D = X(G).matrix, z = new Ba("Push group properties"), F = 0, k = pa(f),
            n = $(f).attr(["filter", "opacity"]), q, u;
        for (F = 0; F < B; F++) {
            var E = m[F];
            if (E.nodeType === 1) {
    ...
    this.updateCanvas = function (f, h) {
        ...
        ma(p, {width: this.contentW * v, height: this.contentH * v, x: G, y: D, viewBox: "0 0 " + this.contentW + " " + this.contentH});
...
(function () {
    ...
    if (!window.methodDraw) window.methodDraw = function (a) {
        ...
        b.init = function () {
            ...
            var p = navigator.userAgent.indexOf("AppleWebKit") >= 0, w = d ? "meta+" : "ctrl+", C = e.pathActions, v = e.undoMgr, L = svgedit.utilities, Q = curConfig.imgPath + "placeholder.svg",
                J = a("#workarea"), H = a("#cmenu_canvas"), U = null, R = 1, N = "toolbars", ca = "";
            ...
            var Na = function (k) {
                ...
                cur_shape = e.addSvgElementFromJson({
                    element: "rect",
                    attr: {x: -1, y: -1, width: Fa.w + 2, height: Fa.h + 2, stroke: "none", id: "canvas_background", opacity: 1, fill: k || "#fff", style: "pointer-events:none"}
                });
            ...
            e.bind("extension_added", function (k, n) {
                ...
                n.context_tools && a.each(n.context_tools, function (ga, T) {
                    ...
                    switch (T.type) {
                        ...
                        case "button-select":
                            ...
                            O.push({elem: "#" + T.id, list: "#" + T.id + "_opts", title: T.title, callback: T.events.change, cur: "#cur_" + T.id});
                            break;
                        case "input":
                ...
                if (n.buttons) {
                    ...
                    a.each(n.buttons, function (ga, T) {
                        ...
                        if (!T.includeWith && !T.list) {
                            ...
                            if (T.type == "mode_flyout") {
                                ...
                                aa["#" + La + "_show"] = T.id;
                                va = ea["#" + Aa[0].id] = [{sel: "#" + va, fn: T.events.click, icon: T.id, isDefault: true}, ub]
                            ...
                            va = ea["#" + Aa[0].id] = [{
                                sel: "#" + va, fn: T.events.click, icon: T.id, key: T.key, isDefault: T.includeWith ? T.includeWith.isDefault :
                                    0
                            }, ub];
                    ...
                    if (S) I = false;
                    a.svgIcons(S, {
                        w: 27, h: 27, id_match: false, no_img: !p, fallback: V, placement: aa, callback: function () {
            ...
            rotateCursor = function (k) {
                k = "rotate(" + k + "deg)";
                Ba.css({"-webkit-transform": k, "-moz-transform": k, "-o-transform": k, "-ms-transform": k, transform: k})
            };
            var xa = function (k) {
                var n = k.value / 100;
                if (n < 0.001) k.value = 0.1; else {
                    k = e.getZoom();
                    var q = J;
                    ia(window, {width: 0, height: 0, x: (q[0].scrollLeft + q.width() / 2) / k, y: (q[0].scrollTop + q.height() / 2) / k, zoom: n}, true)
                }
            };
            ...
            var f = function (k) {
                ...
                a("#color_picker").draggable({
                    ...
                    containment: "window"
                }).removeAttr("style").css(q).jGraduate({paint: u, window: {pickerTitle: k}, images: {clientPath: curConfig.jGraduatePath}, newstop: "inverse"}, function (E) {
            ...
            d = function (k, n) {
                ...
                if (n == "canvas" && q) if (q = q.getAttribute("fill").match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/)) u =
                    {color: ("0" + parseInt(q[1], 10).toString(16)).slice(-2) + ("0" + parseInt(q[2], 10).toString(16)).slice(-2) + ("0" + parseInt(q[3], 10).toString(16)).slice(-2), opacity: 1};
            ...
            var B = function () {
                var k = [{sel: "#tool_select", fn: cb, evt: "click", key: ["V", true]}, {sel: "#tool_fhpath", fn: Ta, evt: "click", key: ["Q", true]}, {
                    sel: "#tool_line",
                    fn: Va,
                    evt: "click",
                    key: ["L", true]
                }, {sel: "#tool_rect", fn: Da, evt: "click", key: ["R", true], icon: "rect"}, {
                    sel: "#tool_ellipse",
                    fn: ua,
                    evt: "mouseup",
                    key: ["C", true],
                    icon: "ellipse"
                }, {sel: "#tool_path", fn: db, evt: "click", key: ["P", true]}, {sel: "#tool_text", fn: Ea, evt: "click", key: ["T", true]}, {sel: "#tool_image", fn: $a, evt: "mouseup"},
                    {sel: "#tool_zoom", fn: Ga, evt: "mouseup", key: ["Z", true]}, {sel: "#tool_clear", fn: Ma, evt: "mouseup", key: [w + "N", true]}, {
                    ...
                    }, {sel: "#tool_export", fn: nb, evt: "mouseup"}, {sel: "#tool_open", fn: Qa, evt: "mouseup"}, {sel: "#tool_import", fn: mb, evt: "mouseup"}, {
                        sel: "#tool_source",
                        fn: Eb,
                        evt: "click",
                        key: [w + "U", true]
                    }, {sel: "#tool_wireframe", fn: Hb, evt: "click"}, {sel: "#tool_snap", fn: Gb, evt: "click"},
                    {sel: "#tool_rulers", fn: Lb, evt: "click"}, {
                        sel: "#tool_source_cancel,#svg_source_overlay,#tool_docprops_cancel,#tool_prefs_cancel",
                        fn: Ab,
                        evt: "click",
                        key: ["esc", false, false],
                        hidekey: true
                    }, {sel: "#tool_source_save", fn: Kb, evt: "click"}, {sel: "#tool_delete,#tool_delete_multi", fn: lb, evt: "click", key: ["del/backspace", true]}, {
                        sel: "#tool_reorient",
                        fn: ob,
                        evt: "click"
                    }, {sel: "#tool_node_link", fn: tb, evt: "change"}, {sel: "#tool_node_clone", fn: ha, evt: "click"}, {sel: "#tool_node_delete", fn: Y, evt: "click"}, {
                        sel: "#tool_openclose_path",
                        fn: M, evt: "click"
                    }, {sel: "#tool_add_subpath", fn: ja, evt: "click"}, {sel: "#tool_move_top", fn: sa, evt: "click", key: w + "shift+up"}, {
                        sel: "#tool_move_bottom",
                        fn: hb,
                        evt: "click",
                        key: w + "shift+down"
                    }, {sel: "#tool_move_up", fn: eb, evt: "click", key: [w + "up", true]}, {sel: "#tool_move_down", fn: sb, evt: "click", key: [w + "down", true]}, {
                        sel: "#tool_topath",
                        fn: ab,
                        evt: "click"
                    }, {sel: "#tool_make_link,#tool_make_link_multi", fn: pb, evt: "click"}, {sel: "#tool_clone,#tool_clone_multi", fn: Fb, evt: "click", key: [w + "D", true]}, {
                        sel: "#tool_group", fn: Bb,
                        evt: "click", key: [w + "G", true]
                    }, {sel: "#tool_ungroup", fn: Bb, evt: "click", key: w + "shift+G"}, {sel: "#tool_unlink_use", fn: Bb, evt: "click"}, {
                        sel: "[id^=tool_align]",
                        fn: bb,
                        evt: "click"
                    }, {sel: "#tool_undo", fn: qb, evt: "click", key: w + "z"}, {sel: "#tool_redo", fn: rb, evt: "click", key: ["y", true]}, {
                        sel: "#tool_cut",
                        fn: Ua,
                        evt: "click",
                        key: [w + "x", true]
                    }, {sel: "#tool_copy", fn: Xa, evt: "click", key: w + "c"}, {sel: "#tool_paste", fn: wb, evt: "click", key: w + "v"}, {
                        sel: "#tool_switch",
                        fn: Ha,
                        evt: "click",
                        key: ["x", true]
                        ...
                        key: [w + "B", true]
                    }, {sel: "#tool_italic", fn: Za, evt: "mousedown", key: [w + "I", true]}, {sel: "#copy_save_done", fn: Ab, evt: "click"}, {
                    ...
                    }, {key: w + "shift+z", fn: rb}, {key: "esc", fn: Ib}], n = {"4/Shift+4": "#tools_rect_show", "5/Shift+5": "#tools_ellipse_show"};
                return {
                    setAll: function () {
                        var q = {};
            ...
            a("#group_opacity").dragInput({min: 0, max: 100, step: 5, callback: changeAttribute, cursor: true, start: 100});
            a("#blur").dragInput({
                        ...
                        k.onloadend = function (q) {
                            insertNewImage = function (K, O) {
                                var V = e.addSvgElementFromJson({
                                    element: "image",
                                    attr: {x: 0, y: 0, width: K, height: O, id: e.getNextId(), style: "pointer-events:inherit"}
                                });
            ...
            var G = b.updateCanvas = function (k, n) {
                    var q = J.width(), u = J.height(), E = q, I = u, K = e.getZoom(), O = J, V = a("#svgcanvas"), aa = {x: O[0].scrollLeft + E / 2, y: O[0].scrollTop + I / 2},
...
$.fn.dragInput = function (a) {
    return this.each(function () {
        ...
        var o = this.dragCfg.dragAdjust, e = $(this).parent(), b = $(this), l = this.dragCfg.height, s = this.dragCfg.min, c = this.dragCfg.max, g = this.dragCfg.step,
            d = c - s > 0 ? (c - s) / g : 200, p = d / l * g, w = 0, C = this.getAttribute("data-attr"), v = methodDraw.canvas, L = svgedit.browser.isTouch(), Q = true,
...
(function (a, o) {
    ...
    a.widget = function (l, s, c) {
        ...
        a[g][l].prototype = a.extend(true, s, {namespace: g, widgetName: l, widgetEventPrefix: a[g][l].prototype.widgetEventPrefix || l, widgetBaseClass: d}, c);
...
(function (a) {
    a.widget("ui.draggable", a.ui.mouse, {
        ...
        _mouseStart: function (o) {
            ...
            a.extend(this.offset, {click: {left: o.pageX - this.offset.left, top: o.pageY - this.offset.top}, parent: this._getParentOffset(), relative: this._getRelativeOffset()});
        ...
        _getParentOffset: function () {
            ...
            if (this.offsetParent[0] == document.body || this.offsetParent[0].tagName && this.offsetParent[0].tagName.toLowerCase() == "html" && a.browser.msie) o = {top: 0, left: 0};
            return {
                top: o.top + (parseInt(this.offsetParent.css("borderTopWidth"), 10) || 0), left: o.left + (parseInt(this.offsetParent.css("borderLeftWidth"),
                    10) || 0)
            }
        },
        ...
        _generatePosition: function (o) {
            var e = this.options, b = this.cssPosition == "absolute" &&
                (this.scrollParent[0] == document || !a.ui.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent, l = /(html|body)/i.test(b[0].tagName),
                s = o.pageX, c = o.pageY;
            ...
            for (var b = a(this).data("draggable"), l = b.options, s = l.snapTolerance, c = e.offset.left, g = c + b.helperProportions.width, d = e.offset.top, p = d + b.helperProportions.height, w = b.snapElements.length - 1; w >= 0; w--) {
                ...
                if (C - s < c && c < v + s && L - s < d && d < Q + s || C - s < c && c < v + s && L - s < p && p < Q + s || C - s < g && g < v + s && L - s < d && d < Q + s || C - s < g && g < v + s && L - s < p &&
                    ...
                    if (l.snapMode != "inner") {
                        ...
                        J && (e.position.top = b._convertPositionTo("relative", {top: L - b.helperProportions.height, left: 0}).top - b.margins.top);
                        H && (e.position.top = b._convertPositionTo("relative", {top: Q, left: 0}).top - b.margins.top);
                        U && (e.position.left = b._convertPositionTo("relative", {top: 0, left: C - b.helperProportions.width}).left - b.margins.left);
                    ...
                    if (l.snapMode != "outer") {
                        ...
                        H && (e.position.top = b._convertPositionTo("relative", {top: Q - b.helperProportions.height, left: 0}).top - b.margins.top);
                        U && (e.position.left = b._convertPositionTo("relative", {top: 0, left: C}).left - b.margins.left);
                        R && (e.position.left = b._convertPositionTo("relative", {top: 0, left: v - b.helperProportions.width}).left - b.margins.left)
                    }
...
(function (a) {
    a.widget("ui.slider", a.ui.mouse, {
        widgetEventPrefix: "slide", options: {animate: false, distance: 0, max: 100, min: 0, orientation: "horizontal", range: false, step: 1, value: 0, values: null}, _create: function () {
            ...
            e = s.offset();
            this._clickOffset = !a(o.target).parents().andSelf().is(".ui-slider-handle") ? {left: 0, top: 0} : {
            ...
            this.options.values && this.options.values.length ? (l = this.values(e ? 0 : 1), this.options.values.length === 2 && this.options.range === true && (e === 0 && b > l || e === 1 && b < l) && (b = l), b !== this.values(e) && (s = this.values(), s[e] = b, c = this._trigger("slide", o, {
                ...
                value: b,
                values: s
            }), this.values(e ? 0 : 1), c !== false && this.values(e, b, true))) : b !== this.value() && (c = this._trigger("slide", o, {handle: this.handles[e], value: b}), c !==
            false && this.value(b))
        }, _stop: function (o, e) {
            var b = {handle: this.handles[e], value: this.value()};
...
(function (a) {
    ...
    var o = function (c, g) {
        ...
        var C = c.eq(3), v = c.eq(4), L = c.eq(5), Q = c.length > 7 ? c.eq(6) : null, J = c.eq(0), H = c.eq(1), U = c.eq(2), R = c.eq(c.length > 7 ? 7 : 6), N = c.length > 7 ? c.eq(8) : null,
            ca = function (ia) {
            ...
            var g = this, d, p, w, C, v, L, Q, J = [], H = function (R) {
                ...
                if (N === undefined) {
                    ...
                    switch (R.toLowerCase()) {
                        ...
                        case "all":
                            return {r: d, g: p, b: w, a: C, h: v, s: L, v: Q, hex: U.call(g, "hex"), ahex: U.call(g, "ahex")};
                        default:
                            N = {};
    ...
    a.fn.jPicker = function (c) {
        ...
        return this.each(function () {
            ...
            var w = parseFloat(navigator.appVersion.split("MSIE")[1]) < 7 && document.body.filters, C = null, v = null, L = null, Q = null, J = null, H = null, U = null, R = null, N = null,
                ca = null, la = null, X = null, W = null, fa = null, ta = null, ia = null, ka = null, Z = null, da = null, pa = null, oa = null, ma = null, na = null, Ja = null, Fa = null,
                Na = null, Sa = null, Ia = null, Ka = function (M) {
                ...
                Ra = function (M) {
                    ...
                    if (p.window.bindToInput && p.window.updateInputColor) p.window.input.css({backgroundColor: P && "#" + P || "transparent", color: M == null || M.v > 75 ? "#000000" : "#ffffff"})
                }, sa = function (M) {
                ...
                null, ob = a.isFunction(g[3]) && g[3] || null, pb = function () {
                    ...
                    var M = function () {
                        if (!(!p.window.expandable || a.support.boxModel)) {
                            ...
                            C.before("<iframe/>");
                            C.prev().css({width: P.width(), height: C.height(), opacity: 0, position: "absolute", left: C.css("left"), top: C.css("top")})
                        }
                    };
                    ...
                    W = new o(v, {
                        ...
                        arrow: {image: ha.clientPath + ha.colorMap.arrow.file, width: ha.colorMap.arrow.width, height: ha.colorMap.arrow.height}
                    });
                    W.bind(xa);
                    fa = new o(L, {
                    ...
                    if (M.expandable) {
                        ...
                        if (M.bindToInput && M.updateInputColor) M.input.css({backgroundColor: Ma && "#" + Ma || "transparent", color: ba == null || ba.v > 75 ? "#000000" : "#ffffff"});
            ...
            a.extend(true, d, {
                commitCallback: ib, liveCallback: ab, cancelCallback: ob, color: ja, show: pb, hide: fb, destroy: function () {
    ...
    a.fn.jPicker.defaults = {
        ...
        color: {
            ...
            quickList: [new b({h: 360, s: 33, v: 100}), new b({h: 360, s: 66, v: 100}), new b({h: 360, s: 100, v: 100}), new b({h: 360, s: 100, v: 75}), new b({
                h: 360,
                s: 100,
                v: 50
            }), new b({h: 180, s: 0, v: 100}), new b({h: 30, s: 33, v: 100}), new b({h: 30, s: 66, v: 100}), new b({h: 30, s: 100, v: 100}), new b({h: 30, s: 100, v: 75}), new b({
                h: 30,
                s: 100,
                v: 50
            }), new b({h: 180, s: 0, v: 90}), new b({h: 60, s: 33, v: 100}), new b({h: 60, s: 66, v: 100}), new b({h: 60, s: 100, v: 100}), new b({h: 60, s: 100, v: 75}), new b({
                h: 60,
                s: 100,
                v: 50
            }), new b({
                h: 180,
                s: 0, v: 80
            }), new b({h: 90, s: 33, v: 100}), new b({h: 90, s: 66, v: 100}), new b({h: 90, s: 100, v: 100}), new b({h: 90, s: 100, v: 75}), new b({h: 90, s: 100, v: 50}), new b({
                h: 180,
                s: 0,
                v: 70
            }), new b({h: 120, s: 33, v: 100}), new b({h: 120, s: 66, v: 100}), new b({h: 120, s: 100, v: 100}), new b({h: 120, s: 100, v: 75}), new b({h: 120, s: 100, v: 50}), new b({
                h: 180,
                s: 0,
                v: 60
            }), new b({h: 150, s: 33, v: 100}), new b({h: 150, s: 66, v: 100}), new b({h: 150, s: 100, v: 100}), new b({h: 150, s: 100, v: 75}), new b({h: 150, s: 100, v: 50}), new b({
                h: 180,
                s: 0,
                v: 50
                ...
                h: 180,
                s: 66, v: 100
            }), new b({h: 180, s: 100, v: 100}), new b({h: 180, s: 100, v: 75}), new b({h: 180, s: 100, v: 50}), new b({h: 180, s: 0, v: 40}), new b({h: 210, s: 33, v: 100}), new b({
                h: 210,
                s: 66,
                v: 100
            }), new b({h: 210, s: 100, v: 100}), new b({h: 210, s: 100, v: 75}), new b({h: 210, s: 100, v: 50}), new b({h: 180, s: 0, v: 30}), new b({h: 240, s: 33, v: 100}), new b({
                h: 240,
                s: 66,
                v: 100
            }), new b({h: 240, s: 100, v: 100}), new b({h: 240, s: 100, v: 75}), new b({h: 240, s: 100, v: 50}), new b({h: 180, s: 0, v: 20}), new b({h: 270, s: 33, v: 100}), new b({
                h: 270,
                s: 66,
                v: 100
            }), new b({h: 270, s: 100, v: 100}),
                new b({h: 270, s: 100, v: 75}), new b({h: 270, s: 100, v: 50}), new b({h: 180, s: 0, v: 10}), new b({h: 300, s: 33, v: 100}), new b({h: 300, s: 66, v: 100}), new b({
                    h: 300,
                    s: 100,
                    v: 100
                }), new b({h: 300, s: 100, v: 75}), new b({h: 300, s: 100, v: 50}), new b({h: 180, s: 0, v: 0}), new b({h: 330, s: 33, v: 100}), new b({h: 330, s: 66, v: 100}), new b({
                    h: 330,
                    s: 100,
                    v: 100
                }), new b({h: 330, s: 100, v: 75}), new b({h: 330, s: 100, v: 50}), new b]
        }, images: {
            clientPath: "/jPicker/images/", colorMap: {width: 256, height: 256, arrow: {file: "mappoint.gif", width: 15, height: 15}}, colorBar: {
                width: 20,
                height: 256, arrow: {file: "rangearrows.gif", width: 20, height: 7}
            }, picker: {file: "picker.gif", width: 25, height: 24}
        }, localization: {
            text: {title: "Drag Markers To Pick A Color", newColor: "new", currentColor: "current", ok: "OK", cancel: "Cancel"}, tooltips: {
...
methodDraw.addExtension("eyedropper", function (a) {
    var o = methodDraw.canvas, e = svgedit.history.ChangeElementCommand,
        b = {fillPaint: "red", fillOpacity: 1, strokePaint: "black", strokeOpacity: 1, strokeWidth: 5, strokeDashArray: null, opacity: 1, strokeLinecap: "butt", strokeLinejoin: "miter"},
        l = function (s, c, g) {
            var d = null;
            if (s.indexOf("url(#") === 0) {
    ...
    return {
        ...
        buttons: [{
            id: "tool_eyedropper", type: "mode", title: "Eye Dropper Tool", position: 8, key: "I", icon: "extensions/eyedropper.png", events: {
                click: function () {
...
methodDraw.addExtension("view_grid", function (a) {
    ...
    if (!document.getElementById("canvasGrid")) {
        ...
        a(e, {
            ...
            x: 0, y: 0, "stroke-width": 0, stroke: "none", fill: "url(#gridpattern)", style: "pointer-events: none; display:visible;"
        });
        $("#canvasGrid").append(e)
    }
    return {
        name: "view_grid", zoomChanged: function (p) {
            ...
            id: "view_grid", type: "menu", after: "tool_wireframe", panel: "view_menu", title: "Voir la grille", events: {
                click: function () {
...
methodDraw.addExtension("shapes", function () {
    ...
    var b, l, s = methodDraw.canvas, c, g, d, p = s.getRootElem(), w = {}, C = {
        ...
        nature: "Nature",
        game: "Cartes et échecs",
        dialog_balloon: "Ballons de dialogue",
        music: "Musique",
        weather: "Météo &amp; Temps",
    ...
    return {
        ...
        buttons: [{
            id: "tool_shapelib", type: "mode_flyout", position: 6, title: "Shape library", icon: "extensions/ext-shapes.png", events: {
                click: function () {
                    s.setMode(Q)
                }
            }
        ...
        mouseDown: function (J) {
            if (s.getMode() === Q) {
                ...
                J = d = J.start_y;
                var U = s.getStyle();
                c = s.addSvgElementFromJson({element: "path", curStyles: true, attr: {d: b, id: s.getNextId(), opacity: U.opacity / 2, style: "pointer-events:none"}});
                c.setAttribute("d", b);
                if (/[a-z]/.test(b)) {
        ...
        mouseMove: function (J) {
            if (s.getMode() ===
                ...
                var ca = c.getBBox();
                H = ca.x;
                var la = ca.y, X = ca.width, W = ca.height, fa = R - g, ta = N - d, ia = {x: Math.min(g, R), y: Math.min(d, N), width: Math.abs(R - g), height: Math.abs(N - d)}, ka = ca = 0;
                W = W ? (W + ta) / W : 1;
                X = X ? (X + fa) / X : 1;
                X = ia.width / w.width;
...
var saveAs = saveAs || function (a) {
    if (!(typeof navigator !== "undefined" && /MSIE [1-9]\./.test(navigator.userAgent))) {
        var o = a.document.createElementNS("http://www.w3.org/1999/xhtml", "a"), e = "download" in o, b = /Version\/[\d\.]+.*Safari/.test(navigator.userAgent), l = a.webkitRequestFileSystem,
