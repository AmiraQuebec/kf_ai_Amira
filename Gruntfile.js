...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        wiredep: {
            target: {
                ...
                exclude: [/bootstrap-sass-official/, /bootstrap.js/, '/json3/', '/es5-shim/', '/tinymce/']
            }
        },
       ...
       shell:{
            runPkg:{
              command: 'NODE_ENV=production pkg package.json --out-path ./pkg'
           }
       },
    ...
    grunt.registerTask('serve', function (target) {
        console.log('serve');
        if (target === 'dist') {
            return grunt.task.run(['env:all','babel', 'env:prod', 'express:prod', 'wait', 'express-keepalive']);
        }
